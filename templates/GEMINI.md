...
| Systematic debugging | `/debug` workflow | 6-phase root cause analysis — auto-engaged for hard bugs, or invoked explicitly |
...
| Post-plan validation | `plan-critic` skill | Adversarial plan check — `/plan` Step 8 |
...
Cross-validate findings. Cap at 3 rounds of diminishing returns — don't over-explore.
